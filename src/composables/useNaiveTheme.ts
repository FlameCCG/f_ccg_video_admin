...
const themeOverridesMap: Record<ThemeName, GlobalThemeOverrides> = {
  ...
  cyberpunk: {
    common: {
      primaryColor: '#d946ef',
      primaryColorHover: '#f0abfc',
      primaryColorPressed: '#c026d3',
      primaryColorSuppl: '#d946ef',
      infoColor: '#00d4ff',
      infoColorHover: '#66e5ff',
      infoColorPressed: '#00b7e6',
      infoColorSuppl: '#00d4ff',
      successColor: '#00ff9d',
      successColorHover: '#5cffc3',
      successColorPressed: '#00cc7d',
      successColorSuppl: '#00ff9d',
      warningColor: '#ffbe0b',
      warningColorHover: '#ffd45e',
      warningColorPressed: '#dba100',
      warningColorSuppl: '#ffbe0b',
      errorColor: '#ff0055',
      errorColorHover: '#ff5c8d',
      errorColorPressed: '#cc0044',
      errorColorSuppl: '#ff0055',
      textColorBase: '#e0e0ff',
      textColor1: '#e0e0ff',
      textColor2: '#a0a0cc',
      textColor3: '#666699',
      textColorDisabled: '#444466',
      placeholderColor: '#666699',
      placeholderColorDisabled: '#444466',
      iconColor: '#a0a0cc',
      iconColorHover: '#e0e0ff',
      iconColorPressed: '#e0e0ff',
      iconColorDisabled: '#444466',
      dividerColor: '#2a2a5a',
      borderColor: '#2a2a5a',
      closeIconColor: '#666699',
      closeIconColorHover: '#a0a0cc',
      closeIconColorPressed: '#e0e0ff',
      closeColorHover: 'rgba(255, 255, 255, 0.08)',
      closeColorPressed: 'rgba(255, 255, 255, 0.12)',
      clearColor: '#666699',
      clearColorHover: '#a0a0cc',
      clearColorPressed: '#e0e0ff',
      scrollbarColor: 'rgba(255, 255, 255, 0.2)',
      scrollbarColorHover: 'rgba(255, 255, 255, 0.3)',
      progressRailColor: '#2a2a5a',
      railColor: '#2a2a5a',
      popoverColor: '#13132b',
      tableColor: '#13132b',
      cardColor: '#13132b',
      ...
      tagColor: '#1c1c3d',
      avatarColor: '#2a2a5a',
      invertedColor: '#e0e0ff',
      inputColor: '#13132b',
      codeColor: '#1c1c3d',
      tabColor: '#13132b',
      actionColor: '#1c1c3d',
      tableHeaderColor: '#0f0f20',
      hoverColor: 'rgba(255, 255, 255, 0.06)',
      tableColorHover: 'rgba(255, 255, 255, 0.06)',
      tableColorStriped: 'rgba(255, 255, 255, 0.03)',
      pressedColor: 'rgba(255, 255, 255, 0.1)',
      opacityDisabled: '0.4',
      inputColorDisabled: '#1c1c3d',
      buttonColor2: 'rgba(217, 70, 239, 0.15)',
      buttonColor2Hover: 'rgba(217, 70, 239, 0.2)',
      buttonColor2Pressed: 'rgba(217, 70, 239, 0.25)',
      boxShadow1: '0 1px 3px 0 rgba(0, 0, 0, 0.3), 0 1px 2px -1px rgba(0, 0, 0, 0.3)',
      boxShadow2: '0 4px 6px -1px rgba(0, 0, 0, 0.35), 0 2px 4px -2px rgba(0, 0, 0, 0.35)',
      boxShadow3: '0 10px 15px -3px rgba(0, 0, 0, 0.4), 0 4px 6px -4px rgba(0, 0, 0, 0.4)',
      borderRadius: '8px',
    ...
    Button: {
      ...
      borderRadiusSmall: '6px',
      borderRadiusLarge: '10px',
      textColorPrimary: '#050510',
      textColorHoverPrimary: '#050510',
      textColorPressedPrimary: '#050510',
      textColorFocusPrimary: '#050510',
    },
    Card: {
      borderRadius: '12px',
      paddingMedium: '16px',
